...
function Interests(props) {
  ...
  return (
    <div className="bg-zinc-800 h-screen">
      <section
        className={`gradient-form h-screen bg-gradient-to-r from-red-200 to-red-600 dark:bg-neutral-700 p-2 w-10/12 float-right ${
          props.userID === 0 ? "mr-[150px]" : "mr-[80px]"
        }`}
      >
          ...
          <fieldset>
            ...
            <ul className="grid w-full gap-6 md:grid-cols-4">
              ...
              <div>
                ...
                >
                  <div className="block">
                    <div className="w-full text-lg font-semibold mx-auto">
                      Puzzle Games
                    </div>
                    <img
                      className="mx-auto w-24"
