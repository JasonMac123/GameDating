...
function Interests(props) {
  ...
  return (
    ...
    <section class="gradient-form h-screen bg-gradient-to-r from-red-200 to-red-600 dark:bg-neutral-700 p-2 mr-10 w-10/12 float-right">
          ...
          <ul class="grid w-full gap-6 md:grid-cols-4">
            ...
            <div>
              ...
              <label for="mmos" class="inline-flex justify-center items-center w-full p-5 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 peer-checked:border-blue-600 hover:text-gray-600 dark:peer-checked:text-gray-300 peer-checked:text-gray-600 hover:bg-gray-50 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div class="block">
                  <div class="w-full text-lg font-semibold">MMO's</div>
                  <img
                    class="mx-auto w-24"
