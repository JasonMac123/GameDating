  ...
  return (
    <section class="gradient-form h-full bg-black dark:bg-neutral-700">
      <div class="container h-full p-10">
        <div
          class="g-6 flex h-full flex-wrap items-center justify-around text-neutral-800 dark:text-neutral-200">
          <div
            class="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
            <div class="g-0 lg:flex lg:flex-wrap bg-gradient-to-r bg-sky-600">
